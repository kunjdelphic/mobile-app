...
class TxEarningToMainWalletDetailsScreen extends StatefulWidget {
  final TransactionHistoryData transactionHistoryData;

  const TxEarningToMainWalletDetailsScreen({
    Key? key,
    required this.transactionHistoryData,
  }) : super(key: key);

  @override
  _TxEarningToMainWalletDetailsScreenState createState() =>
      _TxEarningToMainWalletDetailsScreenState();
}

class _TxEarningToMainWalletDetailsScreenState
    extends State<TxEarningToMainWalletDetailsScreen> {
  @override
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${widget.transactionHistoryData.currency} ${widget.transactionHistoryData.others!.deductFromTransactionFees}',
                          style: kBlackDarkMediumStyle,
                        ),
                      ],
                    ),

...
class AddNewFavoriteScreen extends StatefulWidget {
  final FavoriteCategoriesProducts favoriteProduct;
  const AddNewFavoriteScreen({Key? key, required this.favoriteProduct}) : super(key: key);

  @override
  _AddNewFavoriteScreenState createState() => _AddNewFavoriteScreenState();
}

class _AddNewFavoriteScreenState extends State<AddNewFavoriteScreen> {
  ...
  void initState() {
    ...
    // favoriteController.getRecentTopUp({});
    // favoriteController.getTopUpProducts({
    //   "country": "MY",
    // });
  ...
  Future<OutstandingBill?> getOutstandingBill(Map map) async {
    ...
    if (res.status == 200) {
      ...
      //error
      print("==== ROMIL RESPONSE ${res.message}");
      if (!res.message!.contains('support')) {
  ...
  addNewFavorite() async {
    ...
    //   "account_number": widget.favoriteProduct.fieldsRequired!
    //           .any((element) => element.type == 'ACCOUNT_NUMBER')
    ...
    if (res!['status'] == 200) {
      ...
      Get.back();
      Get.back();
      successSnackbar1(title: ' Added Successfully.');
      favoriteController.allFavorites!.update((val) {
        AllFavoritesData t = AllFavoritesData.fromJson(res!['favorite_item']);
        if (val!.data != null) {
          val.data!.insert(0, t);
        } else {
          val.data = [t];
      ...
      body: GestureDetector(
        ...
        child: ListView(
          ...
          children: [
            ...
            Center(
              child: Text(
                widget.favoriteProduct.name!.split(' ').map((e) => e.capitalize).join(" "),
                style: kBlackDarkMediumStyle,
              ),
            ),
            const SizedBox(
                            ...
                            Expanded(
                              child: ClipRRect(
                                ...
                                child: TextFormField(
                                  ...
                                  focusNode: widget.favoriteProduct.fieldsRequired!.any((element) => element.type == 'PHONE_NUMBER') ? _focusNode : null,
            ...
            widget.favoriteProduct.fieldsRequired!.any((element) => element.type == 'PHONE_NUMBER')
                ...
                : const SizedBox(),
            widget.favoriteProduct.fieldsRequired!.any((element) => element.type == 'ACCOUNT_NUMBER')
                ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
                          ...
                          children: [
                            Expanded(
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(15),
                                child: TextFormField(
                                  focusNode: widget.favoriteProduct.fieldsRequired!.any((element) => element.type == 'ACCOUNT_NUMBER') ? _focusNode : null,
                                  ...
                                  onChanged: (value) {
                                    ...
                                    if (widget.favoriteProduct.hasOutstandingAmount!) {
                                      ...
                                      if (widget.favoriteProduct.fieldsRequired!.singleWhere((element) => element.type == 'ACCOUNT_NUMBER').minLength != '-1') {
                                        if (value.toString().length <
                                            double.parse(widget.favoriteProduct.fieldsRequired!.singleWhere((element) => element.type == 'ACCOUNT_NUMBER').minLength.toString())) {
                                          if (outstandingBill != null) {
                                            outstandingBill = null;
                                            _futureBillPaymentAmts = getOutstandingBill({});
                                          }
                            ...
                            Expanded(
                              child: ClipRRect(
                                ...
                                child: TextFormField(
                                  ...
                                  // focusNode:  widget.favoriteProduct.fieldsRequired!.any((element) => element.type == 'ACCOUNT_NUMBER')  _focusNode,
                                  controller: nicknameController,
                                  onChanged: (value) {
                                    if (isInsertNickname) {
                                      if (value.isNotEmpty) {

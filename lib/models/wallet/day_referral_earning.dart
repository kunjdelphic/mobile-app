class DayReferralEarning {
  int? status;
  String? message;
  DayReferralEarningData? data;

  DayReferralEarning({this.status, this.message, this.data});

  DayReferralEarning.fromJson(Map<String, dynamic> json) {
    status = json["status"];
    message = json["message"];
    data = json["data"] == null
        ? null
        : DayReferralEarningData.fromJson(json["data"]);
  }
...
class DayReferralEarningData {
  String? todaysReferralEarningWalletAmount;
  dynamic totalReferrals;
  LevelWise? levelWise;

  DayReferralEarningData(
      {this.todaysReferralEarningWalletAmount,
      this.totalReferrals,
      this.levelWise});

  DayReferralEarningData.fromJson(Map<String, dynamic> json) {
